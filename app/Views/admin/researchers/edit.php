                ...
                <form action="<?= base_url('admin/researchers/update/' . $researcher['id']) ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-select">
                            <option value="active" <?= old('status', $researcher['status'] ?? 'active') === 'active' ? 'selected' : '' ?>>Active</option>
                            <option value="inactive" <?= old('status', $researcher['status'] ?? '') === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                            <option value="on_leave" <?= old('status', $researcher['status'] ?? '') === 'on_leave' ? 'selected' : '' ?>>On Leave</option>
                            <option value="completed" <?= old('status', $researcher['status'] ?? '') === 'completed' ? 'selected' : '' ?>>Completed</option>
                        </select>
                    </div>

                ...
                <form action="<?= base_url('admin/researchers/update/' . $researcher['id']) ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="author" class="form-control" rows="3" placeholder="Enter each author on a new line"><?= old('author', isset($researcher['author']) ? preg_replace('/,\s*/', "\n", $researcher['author']) : '') ?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Members</label>
                            <textarea name="surname" class="form-control" rows="5" placeholder="Enter each member on a new line" required><?= old('surname', isset($researcher['surname']) ? preg_replace('/,\s*/', "\n", $researcher['surname']) : '') ?></textarea>
                        </div>
                    </div>

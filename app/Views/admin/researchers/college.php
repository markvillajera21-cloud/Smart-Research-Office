...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center">
        <form action="<?= base_url('admin/researchers/college') ?>" method="get" class="d-flex flex-wrap gap-2 align-items-center">
            <!-- School Year -->
...
<div class="card border-0 shadow-sm p-4">
    <!-- Directory Header -->
    <div class="mb-4">
        <h4 class="mb-1 fw-bold text-dark">College Department</h4>
        <p class="text-muted mb-0">Manage college department researchers.</p>
    </div>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="<?= (session()->get('role') === 'admin') ? 10 : 9 ?>" class="text-center py-5 text-muted">
                            ...
                            No researchers found in College Department.
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>

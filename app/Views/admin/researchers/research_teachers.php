...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex flex-wrap gap-2 align-items-center">
        <form action="<?= base_url('admin/researchers/research-teachers') ?>" method="get" class="d-flex flex-wrap gap-2 align-items-center">
            <!-- School Year -->
            ...
            <?php if (($search ?? '') || ($strand ?? '') || ($schoolYear ?? '') || ($category ?? '') || ($adviser ?? '') || ($grammarian ?? '') || ($statistician ?? '') || ($researchTeacher ?? '')): ?>
                <a href="<?= base_url('admin/researchers/research-teachers') ?>" class="btn btn-light border shadow-sm d-flex align-items-center" title="Clear Filters">
...
<div class="card border-0 shadow-sm p-4">
    <div class="mb-4">
        <h4 class="mb-1 fw-bold text-dark">Research by Research Teachers</h4>
        <p class="text-muted mb-0">Manage and filter research by research teachers</p>
    </div>
